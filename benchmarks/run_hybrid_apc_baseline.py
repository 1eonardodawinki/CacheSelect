...
def _run_recorded_request(
    *,
    ...
    row = {
        ...
        "time_to_first_token_ms": response_metrics.get("time_to_first_token_ms"),
        "generation_time_ms": response_metrics.get("generation_time_ms"),
        "queue_time_ms": response_metrics.get("queue_time_ms"),
