...
#     python -m experiments.kv_splice_retrieval
...
from agents.travel_planner_trace import DEFAULT_ROUTES, TOOLS_DESCRIPTION, generate_trace
from experiments.kv_contamination import find_route_block, pick_device
from experiments.kv_splice_generation import get_check_token_spans, run_generation, run_spliced_generation
