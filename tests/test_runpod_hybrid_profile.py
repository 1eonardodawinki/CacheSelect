...
SCRIPT = (
    ...
    / "benchmarks"
    / "run_runpod_hybrid_profile.sh"
)


class RunPodHybridProfileTests(unittest.TestCase):
    ...
    # Preserve the GPU, source, active-profile, and artifact contract.
    def test_preserves_runpod_profile_contract(self) -> None:
